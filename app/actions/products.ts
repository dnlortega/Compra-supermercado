...
function determineCategoryName(name: string): string {
    ...
    const categories: Record<string, string[]> = {
        "Essenciais": ["feijão", "feijao", "arroz", "açúcar", "acucar", "óleo", "oleo", "macarrão", "macarrao", "café", "cafe", "sal", "farinha", "molho", "extrato", "milho", "ervilha", "pipoca", "leite condensado", "creme de leite", "vinagre", "azeite"],
        ...
        "Hortifruti": ["fruta", "legume", "banana", "maçã", "maca", "batata", "cebola", "tomate", "alface", "alho", "cenoura", "abóbora", "abobora", "chuchu", "limão", "limao", "laranja", "pêra", "pera", "melancia", "mamão", "mamao", "abacaxi", "couve", "brócolis", "brocolis", "pimentão", "pimentao", "abobrinha", "ameixa", "manga", "pêssego", "pessego"],
        ...
        "Frios & Laticínios": ["leite", "manteiga", "queijo", "presunto", "iogurte", "yorgute", "danone", "ovo", "requeijão", "requeijao", "margarina", "mortadela", "salame", "peru"],
