...
function determineCategoryName(name: string): string {
    ...
    const categories: Record<string, string[]> = {
        "Essenciais": ["feijão", "feijao", "arroz", "açúcar", "acucar", "óleo", "oleo", "macarrão", "macarrao", "café", "cafe", "sal", "farinha", "molho", "extrato", "milho", "ervilha", "pipoca", "leite condensado", "creme de leite", "vinagre", "azeite", "tempero", "chimichurri", "páprica", "paprica", "colorau", "açafrão", "acafrao", "folha de louro", "folha de louvo", "lentilha"],
        ...
        "Hortifruti": ["fruta", "legume", "banana", "maçã", "maca", "batata", "cebola", "tomate", "alface", "alho", "cenoura", "abóbora", "abobora", "chuchu", "limão", "limao", "laranja", "pêra", "pera", "melancia", "mamão", "mamao", "abacaxi", "couve", "brócolis", "brocolis", "pimentão", "pimentao", "abobrinha", "ameixa", "manga", "pêssego", "pessego", "beterraba", "ovo", "pepino", "beringela", "verduras", "abacate", "kiwi"],
        "Carnes & Aves": ["carne", "frango", "alcatra", "filé", "file", "costela", "coxa", "sobrecoxa", "salsicha", "linguiça", "linguica", "bacon", "bife", "hambúrguer", "hamburguer", "patinho", "coxão", "coxao", "maminha", "bisteca", "porco", "suíno", "suino", "mistura"],
        "Peixaria": ["peixe", "tilápia", "tilapia", "camarão", "camarao", "bacalhau", "pescada", "salmão", "salmao"],
        "Frios & Laticínios": ["leite", "manteiga", "queijo", "presunto", "iogurte", "iorgute", "yorgute", "danone", "requeijão", "requeijao", "margarina", "mortadela", "salame", "peru"],
        ...
        "Higiene": ["papel higiênico", "papel higienico", "sabonete", "creme dental", "pasta de dente", "shampoo", "xampu", "condicionador", "desodorante", "escova", "fio dental", "enxaguante", "listerine", "absorvente", "algodão", "algodao", "lâmina", "lamina", "barbear", "papel toalha", "guardanapo", "cotonete"],
